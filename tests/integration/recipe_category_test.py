...
def test_get_recipe_category_list(client: TestClient, token: str):
...
def test_get_recipe_category_list_invalid_token(client: TestClient):
    response = client.get(f"{url_prefix}/", 
...
def test_get_recipe_category_list_without_token(client: TestClient):
    response = client.get(f"{url_prefix}/")

    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"

def test_get_recipe_category_by_id(client: TestClient, token: str):
...
def test_get_recipe_category_by_id_with_invalid_token(client: TestClient):
    response = client.get(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
...
def test_get_recipe_category_by_id_without_token(client: TestClient):
    response = client.get(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481")

    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"

def test_get_recipe_category_by_wrong_id(client: TestClient, token: str):
...
def test_post_recipe_category(client: TestClient, token: str):
...
def test_post_recipe_category_with_invalid_token(client: TestClient):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test recipe category",
            "created_by": ADMIN_ID
...
def test_post_recipe_category_without_token(client: TestClient):
...
def test_post_recipe_category_with_various_letter_case(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "TEst reCIpe catEGory",
            "created_by": ADMIN_ID
...
def test_post_recipe_category_with_duplicate_name(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "breakfast",
...
def test_post_recipe_category_with_empty_name(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "",
            "created_by_id": ADMIN_ID
...
def test_post_recipe_category_without_name(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "created_by_id": ADMIN_ID
        }, 
...
def test_post_recipe_category_with_not_available_creator_id(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test recipe category",
...
def test_post_recipe_category_with_invalid_creator_id(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test recipe category",
...
def test_post_recipe_category_with_empty_creator_id(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test recipe category",
            "created_by": ""
...
def test_put_recipe_category_by_changing_name(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
...
def test_put_recipe_category_by_changing_name_with_invalid_token(client: TestClient):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "name": "updated recipe category",
        }, 
...
def test_put_recipe_category_by_changing_name_without_token(client: TestClient):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "name": "updated recipe category",
        }
...
def test_put_recipe_category_by_changing_name_with_various_letter_case(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "name": "upDATEd reCIpe caTEgory",
        }, 
...
def test_put_recipe_category_by_changing_name_with_duplicate_name(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "name": "lunch",
        }, 
...
def test_put_recipe_category_by_changing_name_with_empty_name(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "name": "",
        }, 
...
def test_put_recipe_category_with_not_available_creator_id(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "created_by": "3fa85f64-5717-4562-b3fc-2c963f66afa6"
        }, 
...
def test_put_recipe_category_with_invalid_creator_id(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "created_by": "3fa85f64-5717-4562-b3fc-2c963f66afaz"
        }, 
...
def test_put_recipe_category_with_empty_creator_id(client: TestClient, token: str):
    response = client.put(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        json={
            "created_by": ""
        }, 
...
def test_delete_recipe_category(client: TestClient, token: str):
...
def test_delete_recipe_category_with_invalid_token(client: TestClient):
    response = client.delete(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481", 
        headers={"Authorization": f"Bearer invalid_token"}
    )
...
def test_delete_recipe_category_without_token(client: TestClient):
    response = client.delete(f"{url_prefix}/4053a7e8-9ae5-415d-9bed-e4d0a235f481")

    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"
    
def test_delete_recipe_category_by_wrong_id(client: TestClient, token: str):
