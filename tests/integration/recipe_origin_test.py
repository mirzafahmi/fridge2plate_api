...
def test_get_recipe_origin_list(client: TestClient):
...
def test_get_recipe_origin_by_wrong_id(client: TestClient):
...
def test_post_recipe_origin_with_empty_name(client: TestClient):
    response = client.post(f"{url_prefix}/", json={
        "name": "",
        "created_by": ADMIN_ID
    })
...
def test_post_recipe_origin_with_not_available_creator_id(client: TestClient): 
    response = client.post(f"{url_prefix}/", json={
        "name": "test recipe origin",
...
def test_post_recipe_origin_with_invalid_creator_id(client: TestClient): 
    response = client.post(f"{url_prefix}/", json={
        "name": "test recipe origin",
...
def test_post_recipe_origin_with_empty_creator_id(client: TestClient): 
    response = client.post(f"{url_prefix}/", json={
        "name": "test recipe origin",
        "created_by": ""
    })
...
def test_put_recipe_origin_with_not_available_creator_id(client: TestClient):
    response = client.put(f"{url_prefix}/92e80174-c259-480a-80b5-f5b0d32ca005", json={
        "created_by": "3fa85f64-5717-4562-b3fc-2c963f66afa6"
    })
...
def test_put_recipe_origin_with_invalid_creator_id(client: TestClient):
    response = client.put(f"{url_prefix}/92e80174-c259-480a-80b5-f5b0d32ca005", json={
        "created_by": "3fa85f64-5717-4562-b3fc-2c963f66afaz"
    })
...
def test_put_recipe_origin_with_empty_creator_id(client: TestClient):
    response = client.put(f"{url_prefix}/92e80174-c259-480a-80b5-f5b0d32ca005", json={
        "created_by": ""
    })
