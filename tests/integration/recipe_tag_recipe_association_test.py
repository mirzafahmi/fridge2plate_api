...
url_prefix = '/recipe_tag_recipe_association'
...
def test_put_recipe_tag_recipe_association_by_changing_recipe_tag_id(client: TestClient, token: str):
    recipe_tag_recipe_association_id = client.get(f"{url_prefix}/by_recipe_id/2cdd1a37-9c45-4202-a38c-026686b0ff71").json()["recipe_tag_recipe_associations"][0]["id"]
...
def test_put_recipe_tag_recipe_association_by_with_wrong_recipe_tag_id(client: TestClient, token: str):
    recipe_tag_recipe_association_id = client.get(f"{url_prefix}/by_recipe_id/2cdd1a37-9c45-4202-a38c-026686b0ff71").json()["recipe_tag_recipe_associations"][0]["id"]
...
def test_put_recipe_tag_recipe_association_by_with_invalid_recipe_tag_id(client: TestClient, token: str):
    recipe_tag_recipe_association_id = client.get(f"{url_prefix}/by_recipe_id/2cdd1a37-9c45-4202-a38c-026686b0ff71").json()["recipe_tag_recipe_associations"][0]["id"]
...
def test_put_recipe_tag_recipe_association_by_with_empty_recipe_tag_id(client: TestClient, token: str):
    recipe_tag_recipe_association_id = client.get(f"{url_prefix}/by_recipe_id/2cdd1a37-9c45-4202-a38c-026686b0ff71").json()["recipe_tag_recipe_associations"][0]["id"]
...
def test_put_recipe_tag_recipe_association_by_without_data(client: TestClient, token: str):
    recipe_tag_recipe_association_id = client.get(f"{url_prefix}/by_recipe_id/2cdd1a37-9c45-4202-a38c-026686b0ff71").json()["recipe_tag_recipe_associations"][0]["id"]
...
def test_delete_recipe_tag_recipe_association(client: TestClient, token: str):
    recipe_tag_recipe_association_id = client.get(f"{url_prefix}/by_recipe_id/2cdd1a37-9c45-4202-a38c-026686b0ff71").json()["recipe_tag_recipe_associations"][0]["id"]
    ...
    recipe_tag_recipe_association_response = client.get(f"/recipe_tag_recipe_association/{recipe_tag_recipe_association_id}")
