...
def test_get_ingredient_category_list(client: TestClient, token: str):
...
def test_get_ingredient_category_list_with_invalid_token(client: TestClient):
    response = client.get(f"{url_prefix}/", 
...
def test_get_ingredient_category_list_without_token(client: TestClient):
    response = client.get(f"{url_prefix}/")

    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"

def test_get_ingredient_category_by_id(client: TestClient, token: str):
...
def test_get_ingredient_category_by_id_with_invalid_token(client: TestClient):
    response = client.get(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        headers={"Authorization": f"Bearer invalid_token"}
    )
...
def test_get_ingredient_category_by_id_without_token(client: TestClient):
    response = client.get(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03")

    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"

def test_get_ingredient_category_by_wrong_id(client: TestClient, token: str):
...
def test_post_ingredient_category(client: TestClient, token: str):
...
def test_post_ingredient_category_with_invalid_token(client: TestClient):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test ingredient category",
            "created_by": ADMIN_ID
...
def test_post_ingredient_category_without_token(client: TestClient):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test ingredient category",
            "created_by": ADMIN_ID
...
def test_post_ingredient_category_with_various_letter_case(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "Test INgrEDient catEGory",
            "created_by": ADMIN_ID
...
def test_post_ingredient_category_with_duplicate_name(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "proteins",
            "created_by": ADMIN_ID
...
def test_post_ingredient_category_with_empty_name(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "",
            "created_by": ADMIN_ID
...
def test_post_ingredient_category_without_name(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "created_by": ADMIN_ID
        },
...
def test_post_ingredient_category_with_not_available_creator_id(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test ingredient category",
...
def test_post_ingredient_category_with_invalid_creator_id(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test ingredient category",
...
def test_post_ingredient_category_with_empty_creator_id(client: TestClient, token: str):
    response = client.post(f"{url_prefix}/", 
        json={
            "name": "test ingredient category",
            "created_by": ""
...
def test_put_ingredient_category_by_changing_name(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
...
def test_put_ingredient_category_by_changing_name_with_invalid_token(client: TestClient):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "name": "updated ingredient category",
        },
...
def test_put_ingredient_category_by_changing_name_without_token(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "name": "updated ingredient category",
        }
...
def test_put_ingredient_category_by_changing_name_with_various_letter_case(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "name": "upDATed inGREdient cATEgory",
        },
...
def test_put_ingredient_category_by_changing_name_with_duplicate_name(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "name": "vegetables",
        },
...
def test_put_ingredient_category_with_empty_name(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "name": "",
        },
...
def test_put_ingredient_category_with_not_available_creator_id(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "created_by": "3fa85f64-5717-4562-b3fc-2c963f66afa6"
        },
...
def test_put_ingredient_category_with_invalid_creator_id(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "created_by": "3fa85f64-5717-4562-b3fc-2c963f66afaz"
        },
...
def test_put_ingredient_category_with_empty_creator_id(client: TestClient, token:str):
    response = client.put(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03", 
        json={
            "created_by": ""
        },
...
def test_delete_ingredient_category(client: TestClient, token: str):
...
def test_delete_ingredient_category_without_token(client: TestClient):
    response = client.delete(f"{url_prefix}/b4b165f6-a4f2-45f6-bda6-0a49092d3f03")

    assert response.status_code == 401
    assert response.json()["detail"] == "Not authenticated"

def test_delete_ingredient_category_by_wrong_id(client: TestClient, token: str):
    response = client.delete(f"{url_prefix}/db67b3f4-0e04-47bb-bc46-94826847ee4f", headers={"Authorization": f"Bearer {token}"})
