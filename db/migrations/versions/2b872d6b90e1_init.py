...
def upgrade() -> None:
    ...
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('original_recipe_id', sa.UUID(), nullable=True),
    ...
    op.create_table('user_badge_associations',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    op.create_index(op.f('ix_user_badge_associations_id'), 'user_badge_associations', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_ingredient_recipe_associations_id'), 'ingredient_recipe_associations', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_recipe_tag_recipe_associations_id'), 'recipe_tag_recipe_associations', ['id'], unique=False)
    ...
    op.create_index(op.f('ix_recipe_tips_id'), 'recipe_tips', ['id'], unique=False)
    op.create_table('recipe_user_associations',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.Column('liked_date', sa.DateTime(), nullable=True),
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_recipe_user_associations_id'), table_name='recipe_user_associations')
    op.drop_table('recipe_user_associations')
    op.drop_index(op.f('ix_recipe_tips_id'), table_name='recipe_tips')
    op.drop_table('recipe_tips')
    op.drop_index(op.f('ix_recipe_tag_recipe_associations_id'), table_name='recipe_tag_recipe_associations')
    ...
    op.drop_index(op.f('ix_ingredient_recipe_associations_id'), table_name='ingredient_recipe_associations')
    op.drop_table('ingredient_recipe_associations')
    op.drop_index(op.f('ix_user_badge_associations_id'), table_name='user_badge_associations')
    op.drop_table('user_badge_associations')
